// Copyright 2018 Vasudev Kamath. All rights reserved. Use of this code is
// governed by Lesser GNU General Public License v2.1 or later. License text can
// be found in LICENSE file.
